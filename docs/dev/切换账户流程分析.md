...
**定义位置：** [`src/base/BaseEfTask.py#L136`](../../src/base/BaseEfTask.py#L136) `::` `BaseEfTask.iter_multi_account_context`  
...
iter_multi_account_context(repeat_times, empty_accounts_message, ...)
  ...
  │   └─ [`BaseEfTask.set_current_account`](../../src/base/BaseEfTask.py#L109)
...
| **多账号循环执行** | [`BaseEfTask.py`](../../src/base/BaseEfTask.py) | [`#L136`](../../src/base/BaseEfTask.py#L136) | `iter_multi_account_context()` 生成器 |
