...
def install_process_execute_patch():
    ...
    original_execute = process_mod.execute

    def execute_fixed(game_cmd: str, arguments=None,
        ...
        try:
            ...
            process_mod.subprocess.Popen(cmd, cwd=working_dir, shell=True,
    ...
    try:
        process_mod.execute = execute_fixed
        _PATCH_INSTALLED = True
    except Exception:
        process_mod.execute = original_execute
        raise
